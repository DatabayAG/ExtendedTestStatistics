...
class ilExteStatExportOption extends ilBasicExportOption
{
    public const OPTIONS_ID = 'test_exp_option_etstat';
    private ResourceStorage $irss;
    private DataFactory $data_factory;
    private ilExteStatExportRepo $repository;
    ...
    public function init(
        ...
        $this->repository = new ilExteStatExportRepo($DIC->database());
    }
    ...
    {
        // return empty to omit the option on the dropdown on export tab
        return "";
    }
    ...
    public function onDeleteFiles(
        ...
        foreach ($file_identifiers as $file_identifier) {
            ...
            $this->irss->manage()->remove($rid, new ilExtendedTestStatisticsStakeholder());
        }
    }
    ...
    public function onDownloadWithLink(
        ...
        $this->irss->consume()->download($file_identifier->getIdentifier())->run();
    }
